...
```mermaid
flowchart LR
    Z((♟️ Day 0\nBoth start at ZERO)) --> A1["Kid A\nplays for fun"]
    Z --> B1["Kid B\n+1% every single day"]
    A1 --> A2["Day 365\nRoughly the same level"]
    B1 --> B2["Day 365\n37x stronger"]
    B2 --> Top(("🏆 Top 1%\nin the World"))

    style Z fill:#0f2027,stroke:#00c9ff,color:#fff
    style B2 fill:#2c5364,stroke:#00c9ff,color:#fff
    style Top fill:#ffd43b,stroke:#0f2027,color:#000
```
